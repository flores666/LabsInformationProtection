...
/// <summary>
/// Output Feedback (OFB), блок данных из предыдущего шифрованного блока используется как обратная связь
/// Лаба 7
/// </summary>
public class DesOfbEncryptor : DesEncryptorBase
{
    private byte[] _feedback;

    public DesOfbEncryptor(string key) : base(key)
    {
    }
